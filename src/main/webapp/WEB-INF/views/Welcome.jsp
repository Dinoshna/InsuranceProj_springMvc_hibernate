...
<body>
	<section id="navbarBlock">
		<nav>
			<ul>
				<li><a href="<%=request.getContextPath()%>/policy/Welcome">Home</a></li>
				<li><a href="<%=request.getContextPath()%>/policy/userView">View Policies</a>
					
					<ul>
					
						<li><a href="<%=request.getContextPath()%>/policy/userView">Home Insurance</a></li>
							<li><a href="<%=request.getContextPath()%>/policy/userView">Other Insurance</a></li>

					</ul></li>
				<li><a href="<%=request.getContextPath()%>/Benefits">Benefits</a></li>
